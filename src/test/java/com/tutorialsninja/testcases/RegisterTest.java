...
public class RegisterTest extends Base {
	...
	public void verifyRegisteringAnAccountWithMandatoryFields() {
		...
		Assert.assertEquals(accountSuccessPage.retrieveAccountSuccessPageHeading(),
				dataProp.getProperty("accountSuccessfullyCreateHeading"), "Account Success page is not displayed");
	}
	...
	@Test(priority = 4)
	public void verifyRegiteringAccountWithoutProvidingCredentials() {
		...
		Assert.assertTrue(registerPage.displayStatusOfWarningMessages(dataProp.getProperty("privacyPolicyWarning"),
				...
				dataProp.getProperty("emailAddressWarning"), dataProp.getProperty("telephoneWarning"),
